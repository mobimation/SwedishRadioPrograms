...
*/
    ...
    /* It is possible to turn browser audio playback off here
       by loading an empty URL when the user presses the back key.
       And that is what I do now.
       But I kind of like playback continuing when leaving detail view,
       and suggest playback shall stop when leaving the app on top level. */
